...
<body style="font-family:Arial,sans-serif;background:#f4f4f4;margin:0;padding:20px;">
    <div style="max-width:480px;margin:0 auto;background:#fff;border-radius:12px;padding:40px;">
        ...
        <p style="color:#555;margin-bottom:24px;text-align:center;">New Contact Form Message</p>
        ...
        <p style="color:#007f7f;font-weight:bold;font-size:13px;text-transform:uppercase;letter-spacing:1px;margin-bottom:8px;">Message</p>
        <p style="color:#555;font-size:14px;white-space:pre-wrap;">{{ $messageBody }}</p>
        <hr style="border:none;border-top:1px solid #eee;margin:16px 0;">
